...
DEFAULT_CONTENT: dict[str, str] = {
    ...
    "step2Title": "填写邮箱",
    "step2Body": "只需要提供邮箱，用于接收和查询订单信息。",
    "step3Title": "查询交付",
    "step3Body": "管理员交付后，可用订单号和查询码查看结果。",
    "lookupTitle": "查询交付",
    "lookupIntro": "输入订单号和查询码，或打开一次性 token 链接。",
    "faqTitle": "购买说明",
    "faqIntro": "下单前可以先确认支付、查询和交付方式。",
    "faq1Title": "需要注册吗？",
    "faq1Body": "不需要。支付后请保存订单号、查询码和查询链接。",
    "faq2Title": "怎么查询结果？",
    "faq2Body": "使用订单号和查询码，或打开系统生成的查询链接。",
    "faq3Title": "支持哪些支付？",
    "faq3Body": "后台已预留微信和支付宝支付接入，测试环境可使用 Mock 支付。",
}
